...
exports.handler = withSentry(async (event, context) => {
  ...
  try {
    ...
    if (!key) {
      return {
        ...
        body: JSON.stringify({
          ...
          usage: 'POST /kv-set-supabase with JSON body: {"key": "your-key", "value": "your-value"}'
        })
      }
    }
    ...
    console.log(`[kv-set-supabase] Setting key: ${key}`)
    ...
    console.error('[kv-set-supabase] Error:', error)
